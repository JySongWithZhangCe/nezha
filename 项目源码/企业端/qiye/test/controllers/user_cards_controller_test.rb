...
class UserCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_card" do
    assert_difference('UserCard.count') do
      post user_cards_url, params: { user_card: { balance: @user_card.balance, real_money: @user_card.real_money, user_id: @user_card.user_id } }
    end
  ...
  test "should update user_card" do
    patch user_card_url(@user_card), params: { user_card: { balance: @user_card.balance, real_money: @user_card.real_money, user_id: @user_card.user_id } }
