...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { coupon_list_id: @coupon.coupon_list_id, user_id: @coupon.user_id, valid_from: @coupon.valid_from, valid_to: @coupon.valid_to } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { coupon_list_id: @coupon.coupon_list_id, user_id: @coupon.user_id, valid_from: @coupon.valid_from, valid_to: @coupon.valid_to } }
