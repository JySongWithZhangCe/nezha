...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { money: @voucher.money, order_id: @voucher.order_id, payed_at: @voucher.payed_at, status: @voucher.status, user_card_pay: @voucher.user_card_pay } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { money: @voucher.money, order_id: @voucher.order_id, payed_at: @voucher.payed_at, status: @voucher.status, user_card_pay: @voucher.user_card_pay } }
