class Factory < ApplicationRecord
  ...
  has_many :factory_settlement_rules, dependent: :destroy

  has_many :factory_process_records, dependent: :destroy
  has_many :factory_settlement_records, dependent: :destroy
