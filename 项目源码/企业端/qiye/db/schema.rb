...
ActiveRecord::Schema.define(version: 20170510025127) do
  ...
  create_table "factories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_520_ci" do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.string   "fname",                                            collation: "latin1_swedish_ci"
    t.string   "fmoblie",                                          collation: "latin1_swedish_ci"
    t.index ["email"], name: "index_factories_on_email", unique: true, using: :btree
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_520_ci" do |t|
    t.string   "email",                  default: "", null: false, collation: "latin1_swedish_ci"
    t.string   "encrypted_password",     default: "", null: false, collation: "latin1_swedish_ci"
    t.string   "reset_password_token",                             collation: "latin1_swedish_ci"
    t.datetime "reset_password_sent_at"
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.string   "username",                                         collation: "latin1_swedish_ci"
